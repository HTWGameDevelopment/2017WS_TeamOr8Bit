...
#define GV4TOSTR(t) "vec4(" << std::to_string(t.x) << "," << std::to_string(t.y) << "," << std::to_string(t.z) << ", " << std::to_string(t.w) << ")"
#define GV3TOSTR(t) "vec3(" << std::to_string(t.x) << "," << std::to_string(t.y) << "," << std::to_string(t.z) << ")"
#define GV2TOSTR(t) "vec2(" << std::to_string(t.x) << "," << std::to_string(t.y) << ")"
