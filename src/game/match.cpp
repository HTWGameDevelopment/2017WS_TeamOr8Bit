...
void Match::setRenderOffsets(UnitManager &manager) {
    const roff_t offs[] = {
        ...
        roff_t{hextile::hexpoint_t{18,12}, glm::translate(glm::vec3(0.0, 2.5, 0.0))},
        roff_t{hextile::hexpoint_t{17,12}, glm::translate(glm::vec3(0.0, 2.5, 0.0))},
        roff_t{hextile::hexpoint_t{18,13}, glm::translate(glm::vec3(0.0, 2.8, 0.0))},
        roff_t{hextile::hexpoint_t{19,13}, glm::translate(glm::vec3(0.0, 2.5, 0.0))},
        roff_t{hextile::hexpoint_t{19,11}, glm::translate(glm::vec3(0.0, 2.1, 0.0))},
        roff_t{hextile::hexpoint_t{18,10}, glm::translate(glm::vec3(0.0, 1.9, 0.0))},
        roff_t{hextile::hexpoint_t{18,11}, glm::translate(glm::vec3(0.0, 2.1, 0.0))},
        roff_t{hextile::hexpoint_t{19,10}, glm::translate(glm::vec3(0.0, 1.7, 0.0))},
        ...
        roff_t{hextile::hexpoint_t{19,8}, glm::translate(glm::vec3(0.0, 1.3, 0.0))},
        roff_t{hextile::hexpoint_t{19,7}, glm::translate(glm::vec3(0.0, 1.3, 0.0))},
        roff_t{hextile::hexpoint_t{18,7}, glm::translate(glm::vec3(0.0, 1.1, 0.0))},
