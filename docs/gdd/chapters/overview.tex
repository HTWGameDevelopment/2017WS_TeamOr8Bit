...
Round-based strategy game with 3D view on 2D map. Basic idea from "Battle Isle" with elements of base building \index{building} and
...
\begin{itemize}
    \item Moving their units \index{unit}.
    \item Making their units \index{unit} attack something.
    \item Taking over buildings \index{building}.
    \item Placing buildings \index{building}.
\end{itemize}
...
\subsection{Number of buildings \index{building}}
The number of buildings \index{building} depends on the milestones we reach but is at least 4.
